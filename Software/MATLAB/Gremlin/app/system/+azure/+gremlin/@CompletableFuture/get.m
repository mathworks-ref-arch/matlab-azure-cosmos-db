...
% Accessing Completablefuture<ResultSet> object from Handle
cf = obj.Handle;

% Creating a cell array of ResultSet with variable resultsetJ initialized
% to an empty cell array.
% This will be used to collect resultSet objects from
% Completablefuture<ResultSet> 'cf'
resultsetJ = {};

% Iterating through Completablefuture<ResultSet>
for i =1:numel(cf)
    resultsetJ{i} = cf{i}.get();
end

% Creating an empty cell array to contain results and return at the end of
% execution of this method get()
results = {};

% Creating a MATLAB variable response for unpacking of the Resultset java object
response = resultsetJ;
