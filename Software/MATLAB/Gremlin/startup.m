...
if ~isdeployed()
appStr = 'Adding Azure Cosmos DB Gremlin Paths';
disp(appStr);
...
libDir = fullfile(azGremlinCosmosDBRoot,'lib','jar');
jarFiles = dir(fullfile(libDir,'azure-cosmosdb-gremlin-sdk-0.1.0.jar'));
